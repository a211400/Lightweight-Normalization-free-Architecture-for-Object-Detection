...
from yolo.utils import ARM64, IS_JETSON, LINUX, LOGGER, PYTHON_VERSION, ROOT, YAML
from yolo.utils.checks import check_requirements, check_suffix, check_version, check_yaml, is_rockchip
...
class AutoBackend(nn.Module):
    ...
    def __init__(
        ...
        # PyTorch
            ...
            from yolo.nn.tasks import attempt_load_weights
        ...
        # NVIDIA Triton Inference Server
            ...
            from yolo.utils.triton import TritonRemoteModel
