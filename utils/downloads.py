...
from yolo.utils import LOGGER, TQDM, checks, clean_url, emojis, is_online, url2file
...
def delete_dsstore(path, files_to_delete=(".DS_Store", "__MACOSX")):
    ...
    Examples:
        >>> from yolo.utils.downloads import delete_dsstore
...
def zip_directory(directory, compress: bool = True, exclude=(".DS_Store", "__MACOSX"), progress: bool = True) -> Path:
    ...
    Examples:
        >>> from yolo.utils.downloads import zip_directory
...
def unzip_file(
    ...
    Examples:
        >>> from yolo.utils.downloads import unzip_file
...
def get_google_drive_file_info(link: str) -> Tuple[str, str]:
    ...
    Examples:
        >>> from yolo.utils.downloads import get_google_drive_file_info
