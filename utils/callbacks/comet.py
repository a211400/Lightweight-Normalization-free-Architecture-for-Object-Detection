...
from yolo.utils import LOGGER, RANK, SETTINGS, TESTS_RUNNING, ops
from yolo.utils.metrics import ClassifyMetrics, DetMetrics, OBBMetrics, PoseMetrics, SegmentMetrics
...
def _log_plots(experiment, trainer) -> None:
    ...
    Examples:
        >>> from yolo.utils.callbacks.comet import _log_plots
...
def on_fit_epoch_end(trainer) -> None:
    ...
    if curr_epoch == 1:
        from yolo.utils.torch_utils import model_info_for_loggers
