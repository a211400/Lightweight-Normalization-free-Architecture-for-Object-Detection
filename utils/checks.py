...
def parse_requirements(file_path=ROOT.parent / "requirements.txt", package=""):
    ...
    Examples:
        >>> from yolo.utils.checks import parse_requirements
...
def collect_system_info():
    ...
    from yolo.utils import ENVIRONMENT  # scope to avoid circular import
    from yolo.utils.torch_utils import get_cpu_info, get_gpu_info
...
def check_amp(model):
    ...
    Examples:
        ...
        >>> from yolo.utils.checks import check_amp
        >>> model = YOLO("yolo11n.pt").model.cuda()
        >>> check_amp(model)
    """
    from yolo.utils.torch_utils import autocast
...
def is_intel():
    ...
    """
    from yolo.utils.torch_utils import get_cpu_info
