...
def get_cpu_info():
    ...
    from yolo.utils import PERSISTENT_CACHE  # avoid circular import error
...
def select_device(device="", batch=0, newline=False, verbose=True):
    ...
    # Auto-select GPUs
    if "-1" in device:
        from yolo.utils.autodevice import GPUInfo
...
def profile_ops(input, ops, n=10, device=None, max_num_obj=0):
    ...
    Examples:
        >>> from yolo.utils.torch_utils import profile_ops
