...
from yolo.utils import IS_COLAB, IS_KAGGLE, LOGGER, TryExcept, ops, plt_settings, threaded
from yolo.utils.checks import check_font, check_version, is_ascii
...
class Colors:
    ...
    Examples:
        >>> from yolo.utils.plotting import Colors
        >>> colors = Colors()
...
def save_one_box(
    ...
    Examples:
        >>> from yolo.utils.plotting import save_one_box
        >>> xyxy = [50, 50, 150, 150]
...
def plot_results(
    ...
    Examples:
        >>> from yolo.utils.plotting import plot_results
