...
from yolo.utils.tal import TORCH_1_10, dist2bbox, dist2rbox, make_anchors
from yolo.utils.torch_utils import fuse_conv_and_bn, smart_inference_mode
    ...
    def forward(self, x: List[torch.Tensor], batch: Optional[dict] = None) -> Union[Tuple, torch.Tensor]:
        ...
        Returns:
            outputs (tuple | torch.Tensor): During training, returns a tuple of bounding boxes, scores, and other
                ...
                class scores.
        """
        from yolo.models.utils.ops import get_cdn_group
